...
class Message(models.Model):
    receiver_id=models.ForeignKey (settings.AUTH_USER_MODEL,related_name="receiver",on_delete=models.CASCADE,null=True,blank=True)
    ...
    def __str__(self):
        return f"{self.sender_id.name}:{self.content[:20]}"